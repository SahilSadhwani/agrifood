        ...
        <div class="page-container">
                    ...
                    <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
                        ...
                        <li class="nav-item  ">
                            <a href="javascript:;" class="nav-link nav-toggle">
                                ...
                                <span class="title">Process orders</span>
                                <span class="arrow"></span>
                            </a>
                        ...
                        <li class="nav-item  ">
                            <a href="javascript:;" class="nav-link nav-toggle">
                                ...
                                <span class="title">Return Orders</span>
                                <span class="arrow"></span>
                            </a>
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <div class="container">
                        <div class="row">
                            <form action="add-farmer-details.php" method="POST">
                          ...
                          <div class="row">
                           ...
                           <div class="col-md-6">
                               <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="" name="user_password" placeholder="password">
                            </div>
                           </div> 
                           <div class="col-md-6">
                               <div class="form-group">
                                <label for="">Contact</label>
                                <input type="text" class="form-control" id="" name="user_contact" placeholder=contact>
                            </div>
                           </div> 
                           <div class="col-md-6">
                               <div class="form-group">
                                <label for="">Address</label>
                                <input type="text" class="form-control" id="" name="user_address" placeholder="address">
                            </div>
                           </div> 
                           <div class="col-md-6">
                               <div class="form-group">
                                <label for="">Land address</label>
                                <input type="text" class="form-control" id="" name="land_address" placeholder="land address">
                            </div>
                           </div> 
                           <div class="col-md-6">
                               <div class="form-group">
                                <label for="">Land city</label>
                                <input type="text" class="form-control" id="" name="land_city" placeholder="land city">
                            </div>
                           </div> 
                           <div class="col-md-6">
                               <div class="form-group">
                                <label for="">Land registeration number</label>
                                <input type="text" class="form-control" id="" name="land_number" placeholder="registeration number">
                            </div>
                           </div> 
                          </div>
                            ...
                            <button type="submit" class="btn btn-success" style="margin-left:550px; background: #77b122; border-color: #77b122" name="register_farmer">Submit</button>
                        </form>
