            ...
            <div class="page-sidebar-wrapper">
                ...
                <div class="page-sidebar navbar-collapse collapse">
                    ...
                    <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
                        ...
                        <li class="nav-item  ">
                            <a href="javascript:;" class="nav-link nav-toggle" onclick="window.location.href = 'http://localhost/agrifood/src/admin/add-farmer.php'">
                        ...
                        <li class="nav-item  ">
                            <a href="javascript:;" class="nav-link nav-toggle" onclick="window.location.href = 'http://localhost/agrifood/src/admin/display-farmers.php'">
...
require_once("../includes/functions.php");
            $query = "SELECT order_id, user_name, crop_name, quantity, total_amount  FROM order_details, crop, farmer_details, user  WHERE order_details.reached_thirdparty = 1 AND order_details.processed_by_thirdparty = 0 AND order_details.farmer_details_id = farmer_details.farmer_details_id AND farmer_details.user_id = user.user_id AND order_details.crop_id = crop.crop_id";
            ...
            while($row = mysqli_fetch_assoc($result)){
                ...
                echo "<td><a href='qrcode2.php?orderId={$row['order_id']}' class = 'btn btn-success'>Authenticate</a></td></tr>";
            }
