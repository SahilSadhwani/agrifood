        ...
        <div class="page-container">
           ...
           <div class="page-sidebar navbar-collapse collapse">
                    ...
                    <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
                        ...
                        <li class="nav-item  ">
                            <a href="javascript:;" class="nav-link nav-toggle" onclick="window.location.href = 'http://localhost/agrifood/src/admin/process-orders.php'">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                   ...
                   <?php
                        ...
                        ?>
                    <div>
                        <a href="update_order_status.php?order_id=<?php echo $order_id; ?>" class ="btn btn-success" style="margin-left:200px;">Authenticate</a>
                    </div>
