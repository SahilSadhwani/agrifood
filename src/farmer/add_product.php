    ...
    <div class="page-container">
        ...
        <div class="page-content-wrapper">
            ...
            <div class="page-content">
                ...
                <form action="add_to_db.php" method="POST" role="form">
...
<!--                        <input type="text" class="form-control" id="" placeholder="Input field">-->
                   <select name="crop_id" id="crop_name" class="form-control">
                    ...
                    <button type="submit" class="btn btn-primary" name="add_product" style="margin-left:550px; background: #77b122; border-color: #77b122">Submit</button>
                </form>
