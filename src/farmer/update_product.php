    ...
    <div class="page-container">
        ...
        <div class="page-content-wrapper">
            ...
            <div class="page-content">
                ...
                <form action="update_to_db.php" method="POST" role="form">
...
<!--                        <input type="text" class="form-control" id="" placeholder="Input field">-->
                   <select name="crop_id" id="crop_name" class="form-control">
<!--                    <option></option>-->
                            <?php
                                $query = "SELECT crop.crop_id, crop.crop_name from crop , farmer_crop where crop.crop_id = farmer_crop.crop_id and farmer_crop.user_id = 1";
                    ...
                    <div class="row">
                        <div class="col-md-6">
                           <div class="form-group">
                                <label for="">Update Rate</label>
                                <input type="text" name="crop_rate" class="form-control" placeholder="Enter Rate">
                            </div> 
                        </div>
                        <div class="col-md-6">
                            <label for="">Reason for High Rate</label>
                            <select name="rate_reason" id="rate_reason" class="form-control">
                                <option value="1">Normal</option>
                                <option value="2">Weather Condition</option>
                                <option value="3">Land Condition</option>
                            </select>
                        </div>
                    </div>
...
<!--
                    <div class="form-group">
                        <label for="">Rate for 1 kg</label>
                        <input type="text" name="crop_rate" class="form-control">
                    </div>
                    <div class="form-group">
...
-->
                    ...
                    <button type="submit" class="btn btn-primary" style="margin-left:550px; background: #77b122; border-color: #77b122" name="update_product">Submit</button>
                </form>
