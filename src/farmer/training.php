        ...
        <div class="page-container">
                ...
                <div class="page-sidebar navbar-collapse collapse">
                    ...
                    <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
                       ...
                       <li class="nav-item start open">
                        ...
                        <li class="nav-item start open">
                            <a href="javascript:;" class="nav-link nav-toggle" href="training.php">
                                <i class="icon-home"></i>
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                   ...
                   <div class="container">
                       <div class="row">
                           <object width="825" height="450" data="http://www.youtube.com/v/WNVVzEgSU-g" type="application/x-shockwave-flash"><param name="src" value="http://www.youtube.com/v/WNVVzEgSU-g" /></object>
                       </div>
                   </div>
<!--              https://youtu.be/WNVVzEgSU-g-->
                <!-- END CONTENT BODY -->
            </div>
            <!-- END CONTENT -->
        </div>
