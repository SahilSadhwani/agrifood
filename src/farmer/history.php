                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <table style="width:100%; font-size:20px" >
                             ...
                             <?php
                                $query="SELECT * FROM order_details,user,crop WHERE order_left_from_farmer=1 AND reached_thirdparty=1 AND reached_store=1 AND user.user_id=order_details.user_id AND crop.crop_id=order_details.crop_id";
//                                echo $query;
...
//                                print_r($row);
                              ...
                              <tr>
                                ...
                                <td><?php echo $row['order_review']; ?></td>
                              </tr>
                              <?php
                                }
                                    ?>
